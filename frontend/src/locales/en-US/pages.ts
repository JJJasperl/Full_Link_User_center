export default {
  'pages.layouts.userLayout.title':
    'Seamless User Management Across Your Entire Network',
  ...
  'pages.login.username.userCode': 'Please input your user code',
  'pages.login.username.required': 'User name is required!',
  'pages.login.username.userCodeRequired': 'UserCode is required！',
  'pages.login.password.placeholder': 'Please input your password.',
  'pages.login.password.repeat': 'Please repeat your password.',
  'pages.login.password.required': 'Please input your password!',
  'pages.login.password.length': 'Length of password cannot be less than 8!',
  ...
  'pages.register.register.tab': 'Register Account and Password',
